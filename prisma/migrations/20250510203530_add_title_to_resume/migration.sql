...
INSERT INTO "new_Resume" ("about", "avatarUrl", "createdAt", "id", "initials", "location", "locationLink", "name", "personalWebsiteUrl", "summary", "updatedAt", "userId", "title") SELECT "about", "avatarUrl", "createdAt", "id", "initials", "location", "locationLink", "name", "personalWebsiteUrl", "summary", "updatedAt", "userId", "name" FROM "Resume";
DROP TABLE "Resume";
